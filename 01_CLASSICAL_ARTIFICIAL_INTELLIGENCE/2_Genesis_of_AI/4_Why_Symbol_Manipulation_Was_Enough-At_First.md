...
_(Think: in the coding examples we create in code.py, all rules, states, and goals are explicitly defined.)_
...
> **Chapter 2: Introduction of Mathematics to Artificial Intelligence**
